...
class Ui_rulesWindow(object):
    def setupUi(self, rulesWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/images/icons/Zeno_mac.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.actionAddAI = QAction(rulesWindow)
        self.actionAddAI.setObjectName(u"actionAddAI")
        self.actionAddAI.setCheckable(False)
        icon6 = QIcon()
        icon6.addFile(u":/images/icons/sparkle.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionAddAI.setIcon(icon6)
        self.actionDuplicate = QAction(rulesWindow)
        self.actionDuplicate.setObjectName(u"actionDuplicate")
        icon7 = QIcon()
        icon7.addFile(u":/images/icons/duplicate.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionDuplicate.setIcon(icon7)
        self.actionSettings = QAction(rulesWindow)
        self.actionSettings.setObjectName(u"actionSettings")
        icon8 = QIcon()
        icon8.addFile(u":/images/icons/gear.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.toolBar.addAction(self.actionAddAI)
    ...
    def retranslateUi(self, rulesWindow):
        ...
        self.actionAdd.setToolTip(QCoreApplication.translate("rulesWindow", u"Add a new rule", None))
...
#if QT_CONFIG(tooltip)
        self.actionDelete.setToolTip(QCoreApplication.translate("rulesWindow", u"Delete the selected rule", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
...
#if QT_CONFIG(tooltip)
        self.actionExecute.setToolTip(QCoreApplication.translate("rulesWindow", u"Run all enabled rules now", None))
#endif // QT_CONFIG(tooltip)
        self.actionMove_up.setText(QCoreApplication.translate("rulesWindow", u"Move up", None))
#if QT_CONFIG(tooltip)
        self.actionMove_up.setToolTip(QCoreApplication.translate("rulesWindow", u"Move the selected rule up", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
...
#if QT_CONFIG(tooltip)
        self.actionMove_down.setToolTip(QCoreApplication.translate("rulesWindow", u"Move the selected rule down", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionMove_down.setShortcut(QCoreApplication.translate("rulesWindow", u"Down", None))
#endif // QT_CONFIG(shortcut)
        self.actionAddAI.setText(QCoreApplication.translate("rulesWindow", u"Generate with AI", None))
#if QT_CONFIG(tooltip)
        self.actionAddAI.setToolTip(QCoreApplication.translate("rulesWindow", u"Generate a rule using AI", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionAddAI.setShortcut(QCoreApplication.translate("rulesWindow", u"Ctrl+Shift+N", None))
#endif // QT_CONFIG(shortcut)
        self.actionDuplicate.setText(QCoreApplication.translate("rulesWindow", u"Duplicate", None))
#if QT_CONFIG(tooltip)
        self.actionDuplicate.setToolTip(QCoreApplication.translate("rulesWindow", u"Duplicate selected rule", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionDuplicate.setShortcut(QCoreApplication.translate("rulesWindow", u"Ctrl+D", None))
#endif // QT_CONFIG(shortcut)
        self.actionSettings.setText(QCoreApplication.translate("rulesWindow", u"Settings", None))
#if QT_CONFIG(tooltip)
        self.actionSettings.setToolTip(QCoreApplication.translate("rulesWindow", u"Open Zeno settings", None))
#endif // QT_CONFIG(tooltip)
        self.actionAbout.setText(QCoreApplication.translate("rulesWindow", u"About", None))
#if QT_CONFIG(tooltip)
        self.actionAbout.setToolTip(QCoreApplication.translate("rulesWindow", u"About Zeno", None))
#endif // QT_CONFIG(tooltip)
