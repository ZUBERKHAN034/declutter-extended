"""Gemini AI service for generating DeClutter rules from natural language."""
...
_SYSTEM_PROMPT = """\
You are a rule-generation assistant for a macOS file-automation app called DeClutter.
...
class GeminiService:
    ...
    def generate_rule(self, user_prompt: str, context: dict) -> dict:
        ...
        -------
        dict
            A rule dictionary matching the DeClutter schema.
    ...
    def validate_rule_schema(rule_dict: dict) -> None:
        """Validate that *rule_dict* conforms to the DeClutter rule schema.
