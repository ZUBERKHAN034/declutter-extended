"""Dialog to generate a Zeno rule from natural language using Gemini AI."""
...
if sys.platform == "darwin":
    from zeno.ai.gemini_service import GeminiService, MODEL_CHOICES, is_ai_available
...
def _convert_gemini_rule_to_app(gemini_rule: dict) -> dict:
    """Convert the JSON schema returned by Gemini into Zeno's internal rule dict."""
